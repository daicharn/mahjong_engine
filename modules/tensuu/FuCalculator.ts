...
export class FuCalculator{
    ...
    private calcMachuFu(): FuDetail[]{
        ...
        if(machiType.has(MachiType.TANKI)) machiFu.push(new FuDetail("単騎待ち", 2, machiType.get(MachiType.TANKI), MachiType.TANKI));
        else if(machiType.has(MachiType.KANCHAN)) machiFu.push(new FuDetail("嵌張待ち", 2, machiType.get(MachiType.KANCHAN), MachiType.KANCHAN));
        else if(machiType.has(MachiType.PENCHAN)) machiFu.push(new FuDetail("辺張待ち", 2, machiType.get(MachiType.PENCHAN), MachiType.PENCHAN));
